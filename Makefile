...
#
# make program = Download the bin file to the device, using avrdude.
...
AVRDUDE_WRITE_FLASH = -U flash:w:$(TARGET).bin
...
# Change the build target to build a bin file or a library.
